...
for filepath in loadfoldpath.iterdir():
    ...
    graph = get_homogeneous_spatio_temp_chain_graph(
...
graph_type = "spatio_temporal_chain_homogeneous"
...
graph_type = f"spatio_temporal_percentile_{percentile}_homogeneous"
savefile = savefold / f"graph_list_{graph_type}.pt"
