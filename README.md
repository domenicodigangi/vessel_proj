...
Application of machine learning methods to AIS vessel data

## Data and artifacts' management
We use wandb to handle artifacts and log models' performances etc..

- When we want to use wandb we need to init a run (auto linked to the vessel proj) with src.data.init_wandb_run
