...
from src.data import get_file_from_artifact, read_edge_list
...
art_edge = get_file_from_artifact('edge_list:latest')

df_edges = read_edge_list(art_edge.file_path)
df_edges.dtypes   
...
art_ports_info = get_file_from_artifact('ports_info_csv:latest')
df_ports = pd.read_csv(art_ports_info.file_path)
